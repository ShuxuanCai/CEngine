...
namespace CEngine
{
	...
	public:
		...
		const Math::Quaternion& GetRotationCorrection() const { return mRotationCorrection; }
		void SetRotationCorrection(const Quaternion& rot) { mRotationCorrection = rot; }
	...
	private:
		...
		Math::Quaternion mRotationCorrection = Math::Quaternion::Indentity;
	};
}