...
namespace CEngine::Graphics
{
	...
	constexpr uint32_t VE_Position		= 0x1 << 0; // 1
	constexpr uint32_t VE_Normal		= 0x1 << 1; // 2
	constexpr uint32_t VE_Tangent		= 0x1 << 2; // 4
	constexpr uint32_t VE_Color			= 0x1 << 3; // 8
	constexpr uint32_t VE_TexCoord		= 0x1 << 4; // 16
	constexpr uint32_t VE_BlendIndex	= 0x1 << 5; // 32
	constexpr uint32_t VE_BlendWeight	= 0x1 << 6; // 64
	...
	struct Vertex
	{
		...
		float boneWeight[MaxBoneWeights] = {};
	};
}
